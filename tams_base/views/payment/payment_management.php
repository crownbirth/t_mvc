        ...
        <div class="box box-bordered box-color">
            <div class="box-title">
                ...
                <ul class="tabs">
                    ...
                    <?php if($this->main->has_perm('payment', 'payment.setup.view')){?>
                    <li>
                        <a href="#t5" data-toggle="tab">Pay Exception</a>
                    </li>
                    <?php }?>
                </ul>
            </div>                                
                ...
                <div class="tab-content">
                        ...
                        <div class="tab-content">
                            <div class="box-content">
                                ...
                                <table class="table table-bordered table-condensed table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="6"style="text-align: center" class="alert alert" ><?php echo $this->lang->line('access_denied')?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <?php }?>
                    ...
                    <div class="tab-pane" id="t5">
                        <div class="tab-content">
                            <div class="box-content">
                                <ul class="tabs pull-right form">
                                    <?php if($this->main->has_perm('payment', 'payment.setup.create.payexception')
                                            &&
                                            $this->main->has_perm('payment', 'payment.setup.view')){?>
                                    
                                    <li class="btn btn-lime" data-toggle="modal" href="#create_payexception_modal">
                                        <i class="icon-plus"> </i>
                                        Add Pay Exception
                                    </li>
                                ...
                                <table id="all_exception" class="table table-bordered table-condensed table-hover table-striped  dataTable dataTables_paginate dataTables_filter">
                                    <thead>
                                        <tr>
                                            <th width="5">S/N</th>
                                    ...
                                    <tbody>
                                        <tr ng-repeat="excep in data.exceptions">
                                            <td >{{$index + 1}}</td>
                                            <td>{{excep.sesname}} {{excep.type}}</td>
                                            <td>{{excep.unittype}}</td>
                                            <td>{{excep.me}}</td>
                                            <td>{{excep.percentage}} </td>
                                            <td>{{excep.level}}</td>
                                            <td>{{excep.payertype}}</td>
                                            <td>{{excep.admstatus}}</td>
                                            <td> NGN {{excep.ex_amount | number}}</td>
                                            <td>                                                               
                                               <div class="btn-group">
                                                    <a href="#" data-toggle="dropdown" class="btn  btn-lime dropdown-toggle"><i class="icon-cog"> </i> <span class="caret"></span></a>
                                                    <ul class="dropdown-menu">
                                ...
                                <table class="table table-bordered table-condensed table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="10" style="text-align: center" class="alert alert" ><?php echo $this->lang->line('access_denied')?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <?php }?>
                        ...
                        <div class="tab-content">                                                        
                            <div class="box-content">
                                ...
                                <table class="table table-bordered table-condensed table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="3"style="text-align: center" class="alert alert" ><?php echo $this->lang->line('access_denied')?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <?php }?>
                        ...
                        <div class="box box-content">
                           ...
                           <?php }else{?>
                                <table class="table table-bordered table-condensed table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="9" style="text-align: center" class="alert alert" ><?php echo $this->lang->line('access_denied')?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <?php }?>
                        ...
                        <div class="box box-content">                                                                                             
                            ...
                            <?php }else{?>
                                <table class="table table-bordered table-condensed table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="4" style="text-align: center" class="alert alert" ><?php echo $this->lang->line('access_denied')?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <?php }?>
