...
<div 
    ...
    <form 
        ...
        method="post" 
        action="<?php echo base_url('payment/setup/penalty')?>">
                ...
                <div class="controls">
                    <div class="input-xlarge">
                        <select name="status"  class='chosen-select' required="">
                            ...
                            <option value="Active" ng-selected="{{current.panalty_status}}">Activate</option>
                            <option value="Inactive" ng-selected="{{current.panalty_status}}">Inactive</option>
                        </select>                                                                     
                    </div>
                </div>
            </div>
