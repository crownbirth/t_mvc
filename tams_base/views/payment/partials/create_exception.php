<!--create Pay Exception modal-->
<div 
    class="modal hide fade" 
    id="create_exception_modal" 
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">NEW Add Pay Exception</h4>
    </div>
    <form id="create_college_form"
          class="form-horizontal form-striped"
          method="post"
          action="<?php echo base_url('setup/payment/sets/exception')?>">
    <div class="modal-body">
        <div class="control-group">
            <label for="session" class="control-label">Pay Schedule :</label>
            <div class="controls">
                <div class="input-xlarge">
                    <select name="payschedule"  class='chosen-select' required="required">
